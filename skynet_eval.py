...
def main():
    for cf in [50, 75, 150]:  # des_dir_coef
        # for cf in [75]:
        for bs in [0.2, 0.225, 0.275]:  # box_len
            # for bs in [0.15, 0.225, 0.3]:
            for nn_ft_dist in [0.05, 0.1, 0.2, 0.4]:  # next next footstep distance for optimization
                for nn_ft_width in [0.0, 0.075, 0.15]:  # width of nn footstep targets

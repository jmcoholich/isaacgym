...
class Humanoid(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        for i in range(self.num_envs):
            ...
            right_foot_handle = self.gym.find_actor_rigid_body_handle(env_ptr, handle, "right_foot")
            left_foot_handle = self.gym.find_actor_rigid_body_handle(env_ptr, handle, "left_foot")

            env_sensors = []
            env_sensors.append(self.gym.create_force_sensor(env_ptr, right_foot_handle, sensor_pose))
            env_sensors.append(self.gym.create_force_sensor(env_ptr, left_foot_handle, sensor_pose))

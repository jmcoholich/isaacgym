...
from gather_stats_utils import gpu_parallel_cmd_runner, get_ws_from_run_id, \
    get_wandb_run_name_from_id, fname_parser
...
def generate_terrain_cmds(args, env_difficulties, cmd_base):
    cmds = []
    ...
    for infill, height_var in env_difficulties:
        ...
        if get_wandb_run_name_from_id(args.id)[0] == "H":
            cmd += ["--plot_values",
